  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none font-mono">
      ...
      <div className="absolute top-6 left-8 text-[10px] text-gray-400 tracking-[0.2em] uppercase flex items-center space-x-2">
        ...
        <span className="text-gray-500">// SYS_ADMIN</span>
      </div>
      ...
      <div className="absolute top-5 right-8 pointer-events-auto">
        <button 
          ...
          className="text-[10px] text-emerald-400 hover:text-white tracking-[0.2em] uppercase bg-emerald-950/10 hover:bg-emerald-500/10 border border-emerald-500/20 hover:border-emerald-500/50 px-3 py-1.5 rounded transition-all duration-300 cursor-pointer pointer-events-auto"
        >
          [ CONNECT_PORT ]
        </button>
      </div>
